    ...
    public static class CatDinner
    {
        ...
        public static void Dinner()
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(connString))
            {
                ...
                {
                    conn.Open();
                    Console.WriteLine("=============================================== \nFetching Dinner Menu from the database ===============================================");

                    string query = "SELECT Name, Quantity, Price, Status FROM restaurantmenu WHERE Category = 'Dinner'";
                    ...
                    using (MySqlDataReader reader = cmd.ExecuteReader())
                    {
                        ...
                        {
                            Console.WriteLine("No dinner items available in the menu.");
                        }
                    }
                ...
                {
                    Console.WriteLine("Error fetching dinner menu: " + ex.Message);
                }
            }
        }
        ...
        private static void PickOrder(MySqlConnection conn)
        {
            ...
            string query = "SELECT Name, Price, Quantity, Status FROM restaurantmenu WHERE Name = @itemName AND Category = 'Dinner'";
            using (MySqlCommand cmd = new MySqlCommand(query, conn))
            {
