...
namespace CatFour
{
    public static class CatDessert
    {
        ...
        public static void Dessert()
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(connString))
            {
                ...
                {
                    conn.Open();
                    Console.WriteLine("=============================================== \nFetching Dessert Menu from the database ============================");

                    string query = "SELECT Name, Quantity, Price, Status FROM restaurantmenu WHERE Category = 'Dessert'";
                    ...
                    using (MySqlDataReader reader = cmd.ExecuteReader())
                    {
                        ...
                        {
                            Console.WriteLine("No desserts available in the menu.");
                        }
                    }
                ...
                {
                    Console.WriteLine("Error fetching dessert menu: " + ex.Message);
                }
            }
        }
        ...
        private static void PickOrder(MySqlConnection conn)
        {
            ...
            string query = "SELECT Name, Price, Quantity, Status FROM restaurantmenu WHERE Name = @itemName AND Category = 'Dessert'";
            using (MySqlCommand cmd = new MySqlCommand(query, conn))
            {
