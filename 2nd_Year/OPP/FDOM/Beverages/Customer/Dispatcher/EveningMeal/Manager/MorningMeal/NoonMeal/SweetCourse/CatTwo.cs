    ...
    public static class CatLunch
    {
        ...
        public static void Lunch()
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(connString))
            {
                ...
                {
                    conn.Open();
                    Console.WriteLine("=============================================== \nFetching Lunch Menu from the database ===============================================");

                    string query = "SELECT Name, Quantity, Price, Status FROM restaurantmenu WHERE Category = 'Lunch'";
                    ...
                    using (MySqlDataReader reader = cmd.ExecuteReader())
                    {
                        ...
                        {
                            Console.WriteLine("No lunch items available in the menu.");
                        }
                    }
                ...
                {
                    Console.WriteLine("Error fetching lunch menu: " + ex.Message);
                }
            }
        }
        ...
        private static void PickOrder(MySqlConnection conn)
        {
            ...
            string query = "SELECT Name, Price, Quantity, Status FROM restaurantmenu WHERE Name = @itemName AND Category = 'Lunch'";
            using (MySqlCommand cmd = new MySqlCommand(query, conn))
            {
