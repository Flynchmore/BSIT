    ...
    public static class CatDrinks
    {
        ...
        public static void Drinks()
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(connString))
            {
                ...
                {
                    conn.Open();
                    Console.WriteLine("=============================================== \nFetching Drinks Menu from the database ===============================================");

                    string query = "SELECT Name, Quantity, Price, Status FROM restaurantmenu WHERE Category = 'Drinks'";
                ...
                {
                    Console.WriteLine("Error fetching drinks menu: " + ex.Message);
                }
            }
        }
        ...
        private static void PickOrder(MySqlConnection conn)
        {
            ...
            string query = "SELECT Name, Price, Quantity, Status FROM restaurantmenu WHERE Name = @itemName AND Category = 'Drinks'";
            using (MySqlCommand cmd = new MySqlCommand(query, conn))
            {
